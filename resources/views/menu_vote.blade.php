...
<body class="flex items-center justify-center min-h-screen">
    ...
    <div class="space-y-8 w-full max-w-2xl"> <!-- Mengatur container menjadi lebar maksimum dengan width 2xl (640px) -->
        <h1 class="text-center font-extrabold text-3xl drop-shadow-md"><span class="text-blue-900">Gunakan Hak Suara Anda</span> <span class="text-orange-500">Dengan Bijak Ya..</span></h1>
        <br>
        <br>
        ...
        <div class="bg-gradient-to-r from-indigo-600 to-indigo-800 flex items-center space-x-6 shadow-[4.0px_8.0px_8.0px_rgba(0,0,0,0.38)] rounded-lg p-6">
            ...
            <button class="bg-orange-500 text-white text-sm font-semibold px-6 py-3 rounded hover:bg-orange-400 w-40">
                <a href="{{ url('paslon') }}">
        ...
        <div class="bg-gradient-to-r from-zinc-700 to-zinc-900 flex items-center space-x-6 shadow-[4.0px_8.0px_8.0px_rgba(0,0,0,0.38)] rounded-lg p-6">
            <!-- Icon email di sebelah kiri -->
            ...
            <div class="flex-grow">
                <span class="text-red-500 text-xl font-extrabold drop-shadow-md shadow-blue-600/50">Ketua Himpunan</span> <span class="text-white font-semibold">Periode 2024/2025</span>
            </div>
            <!-- Tombol untuk memilih Ketua Himpunan -->
            <button class="bg-red-800 text-white text-sm font-semibold px-6 py-3 rounded hover:bg-red-700 w-40">
            <a href="{{ url('paslon') }}">
