                ...
                <div class="p-6">
                    <div class="flex justify-between items-center mb-4">
                        ...
                        <div class="w-36 h-48 bg-gray-300 flex flex-col items-center justify-center">
                            ...
                            <img src="{{ asset('storage/' . $paslon->ft_ketua) }}" alt="Foto Ketua" class="w-32 h-40 object-cover rounded-md mb-2">
                            <span class="text-black font-semibold">{{ $paslon->nm_ketua }}</span>
                        </div>
                        <!-- Wakil -->
                        <div class="w-36 h-48 bg-gray-300 flex flex-col items-center justify-center">
                            <img src="{{ asset('storage/' . $paslon->ft_wakil) }}" alt="Foto Wakil" class="w-32 h-40 object-cover rounded-md mb-2">
