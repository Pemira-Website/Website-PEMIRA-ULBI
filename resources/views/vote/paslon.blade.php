                ...
                <div class="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                    <div class="sm:flex sm:items-start">
                        ...
                        <div class="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                            <h3 class="text-lg font-medium leading-6 text-gray-900" id="modal-title">Confirm Vote</h3>
                            <div class="mt-2">
                                <p class="text-sm text-gray-500">Are you sure you want to vote for this candidate? This action cannot be undone.</p>
                            </div>
                        </div>
                    </div>
                </div>
