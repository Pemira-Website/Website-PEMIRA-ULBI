            <div
                ...
                <button
                    class="text-white font-semibold py-2 px-6 rounded transition ease-in-out delay-150 bg-red-800 hover:scale-110
                     hover:bg-white hover:text-red-800 duration-300">
