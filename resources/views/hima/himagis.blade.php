...
<body class="bg-gradient-to-r from-orange-100 to-indigo-300 flex items-center justify-center min-h-screen">
    ...
    <div class="space-y-8 w-full max-w-2xl"> <!-- Mengatur container menjadi lebar maksimum dengan width 2xl (640px) -->
        ...
        <div
            ...
            <button
                class="text-white font-semibold py-2 px-6 rounded transition ease-in-out delay-150 bg-red-800 hover:scale-110 hover:bg-white hover:text-red-800 duration-300">
                <a href="{{ url('vote.paslon_himagis') }}">
                    Vote Sekarang
                </a>
            </button>
        </div>
