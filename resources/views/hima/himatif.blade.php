...
<body class="bg-gradient-to-r from-orange-100 to-indigo-300 flex items-center justify-center min-h-screen">
    ...
    <div class="space-y-8 w-full max-w-2xl"> <!-- Mengatur container menjadi lebar maksimum dengan width 2xl (640px) -->
        ...
        <div class="bg-gradient-to-r from-zinc-700 to-zinc-900 flex items-center space-x-6 shadow-[4.0px_8.0px_8.0px_rgba(0,0,0,0.38)] rounded-lg p-6">
            ...
            <div class="flex-grow">
                <span class="text-red-500 text-xl font-extrabold drop-shadow-md shadow-blue-600/50">Ketua Himatif</span> <span class="text-white font-semibold">Periode 2024/2025</span>
            </div>
