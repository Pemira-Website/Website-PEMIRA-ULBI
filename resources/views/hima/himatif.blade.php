...
<div class="bg-gradient-to-r from-zinc-700 to-zinc-900 flex items-center 
    ...
    <div class="flex-grow">
        <span class="text-white text-xl font-extrabold drop-shadow-md shadow-blue-600/50">Ketua Himatif</span> 
