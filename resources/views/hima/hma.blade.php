        ...
        <div class="bg-white flex items-center space-x-6 shadow-[4.0px_8.0px_8.0px_rgba(0,0,0,0.38)] rounded-lg p-6">
            ...
            <button
                class="text-black font-semibold py-2 px-6 rounded transition ease-in-out delay-150 bg-yellow-400 
                hover:scale-110 hover:bg-white hover:text-yellow-400 duration-300">
