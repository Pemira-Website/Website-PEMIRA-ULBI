...
<div class="bg-gradient-to-r from-blue-700 to-blue-900 flex items-center justify-between space-x-6  shadow-[4.0px_8.0px_8.0px_rgba(0,0,0,0.38)] rounded-xl p-6">
    <div class="flex-shrink-0 w-16 h-16 flex items-center justify-center rounded-full shadow-lg" style="box-shadow: 0 4px 8px rgba(0, 0, 0, 0.3);">
        <img class="max-w-full" src="<?php echo e(asset('images/bem.png')); ?>" alt="Logo Bem">
    </div>
    ...
    <a href="<?php echo e($pml_presma > 0 ? '#' : route('vote.show', ['jenis_pemilihan' => 'presma'])); ?>" 
       class="block text-center <?php echo e($pml_presma > 0 ? 'cursor-not-allowed' : ''); ?>">
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($pml_presma > 0): ?> Sudah Memilih <?php else: ?> Vote Sekarang <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    </a>
</button>
</div>
<?php /**PATH D:\Kegabutan\menyusahkan\pemira_26\resources\views\presma\presma.blade.php ENDPATH**/ ?>