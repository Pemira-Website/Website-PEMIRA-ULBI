...
<?php endif; ?>
        <?php else: ?>
            <div class="grid gap-3 mx-px mb-px">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $queues; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $queue => $readings): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
Alpine.data('queueChart', (config) => ({
    ...
    ?>
<?php /**PATH D:\Kegabutan\menyusahkan\pemira_26\vendor\laravel\pulse\resources\views\livewire\queues.blade.php ENDPATH**/ ?>