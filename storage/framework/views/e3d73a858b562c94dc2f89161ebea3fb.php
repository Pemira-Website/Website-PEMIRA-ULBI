<div class="bg-white p-10 rounded-lg shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px] w-full">
    ...
    <?php $__env->startPush('js'); ?>
        ...
        <script>
            ...
            // Inisialisasi chart
            let chartData = JSON.parse(<?php echo json_encode($totalVote, 15, 512) ?>);
            ...
            const config = {
                ...
                plugins: [{
                    ...
                    chart) { // Menggunakan beforeDraw untuk menggambar gambar di belakang chart
                        const ctx = chart.ctx;
                        const images = [
                            '<?php echo e(asset('images/paslon1.png')); ?>',
                            '<?php echo e(asset('images/paslon2.png')); ?>'
                        ];
...
<?php /**PATH D:\Kegabutan\menyusahkan\pemira_26\resources\views\livewire\presma-live-chart.blade.php ENDPATH**/ ?>