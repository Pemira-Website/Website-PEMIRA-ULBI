...
<?php endif; ?>
        <?php else: ?>
            <div class="grid grid-cols-1 @lg:grid-cols-2 @3xl:grid-cols-3 @6xl:grid-cols-4 gap-2">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $userRequestCounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $userRequestCount): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php endif; ?>
<?php /**PATH D:\Kegabutan\menyusahkan\pemira_26\vendor\laravel\pulse\resources\views\livewire\usage.blade.php ENDPATH**/ ?>