    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div class="group bg-gradient-to-br from-teal-50 to-cyan-100 rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 border-t-4 border-teal-500">
          ...
          <h3 class="text-xl font-bold text-teal-700 mb-3"><?php echo e(\App\Support\PemiraConfig::publicPrivacyHeadline()); ?></h3>
          <p class="text-gray-600"><?php echo e(\App\Support\PemiraConfig::publicPrivacyDescription()); ?></p>
        </div>
      ...
      <div class="space-y-4">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden hover:shadow-md transition-shadow">
          <div class="p-6">
            ...
            <p class="text-gray-600"><?php echo e(\App\Support\PemiraConfig::publicPrivacyFaqAnswer()); ?></p>
          </div>
        </div>
